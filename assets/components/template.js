...
Sixth International Conference on Sustainable Energy, Environment, and Green Technologies (ICSEEGT 2026)</b>
        </h1>
...
export const aside = `
      ...
      <div class="full-w mt-5 column shadow rounded-2 p-3 date-ctnr">
         ...
         <p>After peer review by the journal selected papers from ICSEEGT 2025 will be published in a special issue entitled " Recent Environmental and Renewable Energy Innovations for a Sustainable Future'' in Environmental Science and Pollution Research (ESPR) of Springer.</p>
       </div>`