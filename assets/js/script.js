...
import { header, aside, footer } from "/assets/components/template.js";

const headerEl = document.getElementById("main-header");
const asideEl = document.getElementById("main-aside");
...
document.querySelectorAll(".view-more-btn").forEach((btn) => {
  btn.addEventListener("click", function () {
    ...
    this.innerHTML = list.classList.contains("expanded")
      ? 'View Less <img src="assets/icons/down.svg" alt="down" style="transform: rotateZ(180deg)">'
      : 'View More <img src="assets/icons/down.svg" alt="down">';
  });
});